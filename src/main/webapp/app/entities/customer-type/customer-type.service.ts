...
export class CustomerTypeService {
    ...
    create(customerType: CustomerType): Observable<CustomerType> {
     ...
     */
    private convertItemFromServer(json: any): CustomerType {
        const entity: CustomerType = Object.assign(new CustomerType(), json);
        return entity;
    }
